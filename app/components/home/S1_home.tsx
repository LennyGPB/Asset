...
export default function S1_home() {
  return (
    <>
      ...
      <p className="bg-white font-semibold text-xl tracking-[4px] p-3 rounded-lg mt-7 w-[1200px] mx-auto">
        Le marché des créateurs numériques, offrant une large gamme de scripts,
        assets, et ressources pour vos jeux vidéos, logiciels, projets...
      </p>
